...
def build_straw_multisheet_xlsx(state, field_rows):
    ...
    style_xml = '''<styleSheet xmlns="%s"><fonts count="1"><font><sz val="11"/><name val="Calibri"/></font></fonts><fills count="6"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="solid"><fgColor rgb="FF4F8F46"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FFDFBD56"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FFD78632"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FF4D8F9E"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FF8FA84F"/></patternFill></fill></fills><borders count="1"><border><left/><right/><top/><bottom/><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="6"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/><xf numFmtId="0" fillId="1" borderId="0" xfId="0" applyFill="1"/><xf numFmtId="0" fillId="2" borderId="0" xfId="0" applyFill="1"/><xf numFmtId="0" fillId="3" borderId="0" xfId="0" applyFill="1"/><xf numFmtId="0" fillId="4" borderId="0" xfId="0" applyFill="1"/><xf numFmtId="0" fillId="5" borderId="0" xfId="0" applyFill="1"/></cellXfs></styleSheet>''' % XLSX_NS
    sheets_xml = {}
    for index, (name, data) in enumerate(sheets, 1):
        ...
        for r, values in enumerate(data, 1):
            ...
            for c, value in enumerate(values, 1):
                style = 1 if r == 1 else ({"Wheat":2,"Barley":3,"Oats":4,"Spring Barley":5,"Hay":5}.get(str(value),0) if c == 4 else 0)
